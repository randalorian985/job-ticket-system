...
{
    [HttpGet]
    public async Task<ActionResult<IReadOnlyList<EquipmentDto>>> ListAsync([FromQuery] int offset = 0, [FromQuery] int limit = 50, CancellationToken cancellationToken = default)
