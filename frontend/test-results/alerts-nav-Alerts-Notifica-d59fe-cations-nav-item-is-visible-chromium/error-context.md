...
- Name: alerts-nav.spec.ts >> Alerts & Notifications page >> Alerts & Notifications nav item is visible
- Location: e2e\alerts-nav.spec.ts:15:3
...
Locator: getByRole('link', { name: 'Alerts & Notifications' })
Expected: visible
Timeout: 5000ms
