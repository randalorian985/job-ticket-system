...
## Scope
- Audit the existing job-ticket/work-order model, APIs, forms, routes, permissions, activity history, and tests.
...
## Guardrail
Do not add equipment, ticket contacts, assignments, labor, parts, scheduling, or broad quick-add behavior in this slice.