...
- Manager/Admin job-ticket queue supports both rich readiness cards and a persisted compact operating list for dense day-to-day scanning. Queue export produces client-side CSV from the currently visible filtered ticket rows, including readable customer, service-location, assignment, lead, and work-readiness labels. This does not add backend export endpoints or reporting jobs.
