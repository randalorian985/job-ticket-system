...
- Manager/Admin ticket detail uses focused in-page panels for ticket editing, status changes, archive review, and Add / Request Part actions backed by existing APIs; the recommended action opens the relevant workflow tab in a focused ticket view.
...
- Manager/Admin screen cleanup uses distinct report catalog/results, master-data list/editor, and Admin user list/editor states while preserving create/update/archive and account-management outcomes.
