...
- The current merge candidate is a post-reports historical regression audit and docs checkpoint before any new feature lane is selected.
...
- use the current checkpoint for historical regression review and docs alignment rather than a new domain expansion;
