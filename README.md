...
- Manager/Admin job ticket edit surfaces now show dispatch edit-readiness cues for customer, service location, equipment or no-equipment context, schedule, due date, and job instructions using existing job-ticket fields.
...
- Manager/Admin job ticket edit readiness review for customer, service location, equipment or no-equipment context, schedule, due date, and job instructions before dispatch handoff.
