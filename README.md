...
- Manager/Admin dashboard create-ticket shortcut plus job-ticket create/edit quick-add for job type reference values, service locations, and equipment, using existing service-location and equipment master-data APIs, preserving the selected customer/service-location relationship, warning about possible duplicate equipment before save, and showing recent selected-equipment service-history context from existing report data.
